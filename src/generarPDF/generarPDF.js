       ...
       .fillColor("black");
        ...
        for (var i = 0; i < facturas.compras.length; i++) {
          ...
          filaRegistro(
            ...
            doc,
            position ,
            facturas.compras[i].productos.idProducto,
            facturas.compras[i].productos.nombreProducto,
            facturas.compras[i].productos.cantidad,
            facturas.compras[i].productos.precio,
            facturas.compras[i].productos.subTotal,
